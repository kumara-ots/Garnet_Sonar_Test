...
public class EmailUtil {
	...
	public void sendDistributermailWithAttachment(String to, String cc, String sub, String msg, byte[] attachmentBytes,
			String fileName) {
		Properties props = new Properties();
		props.put("mail.smtp.auth", true);
		props.put("mail.smtp.starttls.enable", true);
	...
	public void sendFinanceMailWithAttachment(String cc, String sub, String msg, byte[] attachmentBytes,
			String fileName) {
		Properties props = new Properties();
		props.put("mail.smtp.auth", true);
		props.put("mail.smtp.starttls.enable", true);
